...
url = "https://www.brecorder.com/news/40298556/oil-tanker-mafia-pm-shehbaz-again-pushes-for-renewable-energy-generation"
req = requests.get(url)
soup = BeautifulSoup(req.content, "html.parser")

title_element = soup.find("h1", attrs={"data-id": "40298556"})
