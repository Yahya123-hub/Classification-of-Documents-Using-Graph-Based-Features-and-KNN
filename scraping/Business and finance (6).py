...
url = "https://www.brecorder.com/news/40298563/leak-of-corporate-data-cyber-attack-hits-pak-suzuki-motor-company"
req = requests.get(url)
soup = BeautifulSoup(req.content, "html.parser")

title_element = soup.find("h1", attrs={"data-id": "40298563"})
