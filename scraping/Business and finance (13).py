...
url = "https://www.brecorder.com/news/40298718/pakistan-and-imf-discussing-new-multi-billion-dollar-program-finance-minister-says"
req = requests.get(url)
soup = BeautifulSoup(req.content, "html.parser")

title_element = soup.find("h1", attrs={"data-id": "40298718"})
